...
var l = "8";
// 請文字解釋為什麼
console.log(k * l > 21); //js會型別轉換，string字串8會變成number數字8，3*8=24>21
...
const gymCoach = [{
  coachName:"王教練",
  personalTrainingcost:2000,
  personalTrainingtime:60,
  groupTrainingcost:1500,
  groupTrainingtime:90
},
{
  coachName:"李教練",
  personalTrainingcost:1800,
  personalTrainingtime:50,
  groupTrainingcost:1200,
  groupTrainingtime:75
}];// 練習：使用物件變數定義兩位教練的資訊
...
let calorieBurn = 0;
calorieBurn = 10*2* activities.cycling.caloriesPerMinute + 30* activities.treadmill.caloriesPerMinute + 40* activities.yoga.caloriesPerMinute
