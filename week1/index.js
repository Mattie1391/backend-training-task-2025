...
const yogaClass = 300;
const workoutClass = 500;
const personalTraining = 1500;
...
let AlexBudget = alexSportbudget - (yogaClass * 3 + workoutClass + personalTraining);
...
const classMinutes = 50;
const classAverageprice = 180;
const fourteenClasspackageprice = 2520;
const fourteenClassprice = fourteenClasspackageprice/0.9;
...
myWater -= 500; // 早上喝了 500cc myWater = myWater -500 = 2000-500 = 1500
// a -= b 代表 a = a - b;
myWater -= 800;
myWater += 1000;
myWater -= 700;
...
const groupUsePrice = 150;
let machineUsePriceTotal = machineUsePrice * 3;
let groupClassesTotal = groupUsePrice * 2;
...
a = 13; // 改變 a 的值為 13
a = b + 4; //改變 a 的值為 0 + 4 = 4
a - b; // 4 - 0 但值沒有存下來
b += 1; // 改變 b 的值為 b = b + 1 = 0 + 1 = 1
...
let h = f + g; // h 是 number 因為false = 0
